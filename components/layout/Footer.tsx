...
import { Instagram, Linkedin, Facebook, Sparkles } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-white">NextFund Advisory</span>
            </Link>
            <p className="text-sm text-gray-500 leading-relaxed mb-6">
              Finanza agevolata di nuova generazione. AI-powered solutions per la crescita del tuo business.
            </p>
