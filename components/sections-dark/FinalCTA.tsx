...
export function FinalCTA() {
  return (
    <section className="relative py-32 bg-dark-bg-primary overflow-hidden">
      {/* Background Glow */}
      <div className="absolute inset-0 bg-gradient-radial from-nextfund-blue/10 via-transparent to-transparent" />
      ...
      <div className="container px-4 relative z-10">
        ...
        >
          {/* Icon */}
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-nextfund-blue/20 mb-8">
