  ...
  return (
    <section className="py-8 lg:py-12 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-primary text-primary-foreground rounded-[2.5rem] overflow-hidden">
            ...
            <div className="px-8 md:px-12 lg:px-16 py-12 lg:py-20 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button
                  size="lg"
                  variant="ghost"
                  className="text-primary-foreground hover:bg-primary-foreground/10 rounded-full px-8 border-0"
                >
                  Scopri i servizi
                </Button>
              </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-64 h-64">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                      <div className="h-24 w-24 rounded-full bg-primary-foreground/10 flex items-center justify-center backdrop-blur-sm">
                    ...
                    <div className="absolute top-0 left-1/2 -translate-x-1/2">
                      <div className="h-16 w-16 rounded-full bg-primary-foreground/10 flex items-center justify-center backdrop-blur-sm">
