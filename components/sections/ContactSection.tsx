      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16 max-w-5xl mx-auto">
          {contactMethods.map((method, index) => (
            <div
              key={index}
              className="text-center p-6 rounded-lg border-2 border-gray-100 hover:border-nextfund-blue/30 transition-all duration-300"
            >
              <div className="w-14 h-14 rounded-full bg-nextfund-blue/10 flex items-center justify-center mx-auto mb-4">
