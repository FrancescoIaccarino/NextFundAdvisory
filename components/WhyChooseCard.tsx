...
export function WhyChooseCard({ title, description, color }: WhyChooseCardProps) {
  ...
  return (
    <div className={`${bgLight} rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300`}>
      <div className={`w-14 h-14 rounded-full ${bgColor} flex items-center justify-center mx-auto mb-4`}>
